...
const char * const BITCOIN_CONF_FILENAME = "tdkcoin.conf";
const char * const BITCOIN_PID_FILENAME = "tdkcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TdkCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/TdkCoin";
#else
    // Unix
    return pathRet / ".tdkcoin";
#endif
#endif
}
