...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tdkcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tdkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tdkcoin transaction") + "\n" +
              "  tdkcoin-tx [options] -create [commands]   " + _("Create hex-encoded tdkcoin transaction") + "\n" +
              "\n";
