...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/XGoldCoin/tdkcoin>";
    const std::string URL_WEBSITE = "<https://github.com/XGoldCoin/tdkcoin>";
